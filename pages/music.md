...
<section class="container projects-grid music-cards">
  <a href="{{ '/projects/fractal-fade/' | relative_url }}" class="project-card">
  ...
  <a href="{{ '/music/eman-safavi/' | relative_url }}" class="project-card">
...
<section class="container">
  <ul class="project-links">
    <li>
      <a href="{{ '/projects/moor-by-maris-halna/' | relative_url }}">Moor by Maris Halna</a>
    </li>
  </ul>
</section>
